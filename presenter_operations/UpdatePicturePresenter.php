...
<head>
    ...
    <title>Inserisci Foto Presenter</title>
</head>
                    ...
                    <div class="myform form">
                        <div class="logo mb-2">
                            <div class="col-md-12 text-center">
                                <h1>Inserisci Foto Presenter</h1>
                            </div>
                        </div>

                        
                        <form form name="frmContact" method="post" action="UpdatePicturePresenterLogic.php" autocomplete="off">
                        ...
                        <div class="form-outline mb-4">
                            <div class="input-group">
                                <input type="file" class="form-control form-control-lg" name="foto_presenter">
                            </div>
                        </div>
