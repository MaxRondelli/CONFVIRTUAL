...
try {
    ...
    $nomeUniversita = $_POST['nome_universita_presenter'];
    $dipartimentoUniversita = $_POST['dipartimento_universita_presenter'];

    $query = "CALL inserimentoAffiliazioneUniPRESENTER(:lab1, :lab2, :lab3)";
