            ...
            <div class="col-md-5 mx-auto">
                <div id="first">
                    <div class="myform form">
                        ...
                        <form form name="frmContact" method="post" action="FavouritePresentationLogic.php" autocomplete="off">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-outline mb-4">
                                                <select name="codice_presentazioni">
                                                    ...
                                                    $query = ('SELECT Codice FROM PRESENTAZIONE');
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    // $loginResult = $con->prepare($login);
                                                    // $loginResult->execute();
                                                    // $row1 = $loginResult->fetch();

                                                    // if ($row1["UsernameUtente"] == $_SESSION['username']) {
                                                    //     while ($row = $result->fetch()) {
                                                    //         echo "<tr>";
                                                    //         echo "<td>" . $row['CodicePresentazione'] . "</td>";
                                                    //         echo "</tr>";
